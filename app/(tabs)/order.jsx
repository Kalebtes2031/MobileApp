...
const Order = () => {
    ...
    items.map((item) => (
      <View key={item.id} style={styles.itemContainer}>
        ...
        <View style={styles.itemDetails}>
          <Text style={styles.itemName}>{item.product?.item_name || 'Unknown Product'}</Text>
  ...
  const renderOrders = () => {
    ...
    if (!orders.length) {
      return <Text style={styles.noOrdersText}>No orders found. Start shopping!</Text>;
    }
      ...
      {!isLogged ? (
        <View style={styles.loginPromptContainer}>
          <Text style={styles.loginPromptText}>
            Please <Link href="/(auth)/sign-in" style={styles.loginLink}>Login</Link> to view your orders
          </Text>
        </View>
      ) : (
